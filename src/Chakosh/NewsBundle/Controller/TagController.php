...
use Chakosh\NewsBundle\Entity\Tag;
use Chakosh\NewsBundle\Form\TagType;
...
class TagController extends Controller
{
    ...
    public function indexAction()
    {
        ...
        $entities = $em->getRepository('ChakoshNewsBundle:Tag')->findAll();

        return $this->render('ChakoshNewsBundle:Tag:index.html.twig', array(
            'entities' => $entities,
        ));
    }
    /**
    ...
    public function createAction(Request $request)
    {
        ...
        return $this->render('ChakoshNewsBundle:Tag:new.html.twig', array(
            'entity' => $entity,
    ...
    */
    ...
    public function showAction($id)
    {
        ...
        $entity = $em->getRepository('ChakoshNewsBundle:Tag')->find($id);
        ...
        return $this->render('ChakoshNewsBundle:Tag:show.html.twig', array(
            'entity'      => $entity,
    ...
    public function editAction($id)
    {
        ...
        return $this->render('ChakoshNewsBundle:Tag:edit.html.twig', array(
            'entity'      => $entity,
