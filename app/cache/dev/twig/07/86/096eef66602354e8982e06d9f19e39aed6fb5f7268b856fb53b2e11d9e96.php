...
/* LiipSearchBundle:Search:search_results.html.twig */
class __TwigTemplate_0786096eef66602354e8982e06d9f19e39aed6fb5f7268b856fb53b2e11d9e96 extends Twig_Template
{
    ...
    ";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["result"]) {
            ...
            <a href=\"";
            // line 4
            echo twig_escape_filter($this->env, $this->getAttribute((isset($context["result"]) ? $context["result"] : $this->getContext($context, "result")), "url"), "html", null, true);
            echo "\">";
            echo $this->getAttribute((isset($context["result"]) ? $context["result"] : $this->getContext($context, "result")), "title");
            echo "</a>
        </dt>
        <dd>";
            // line 6
            echo $this->getAttribute((isset($context["result"]) ? $context["result"] : $this->getContext($context, "result")), "summary");
            echo "</dd>
    ";
        }
...
";
    ...
    {
        return "LiipSearchBundle:Search:search_results.html.twig";
    }
